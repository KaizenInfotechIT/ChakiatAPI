...
namespace TouchBaseWebAPI.BusinessEntities
{
    public class MemberMaster
    {
        ...
        {
            #region this is the old code commented by Mukesh Dhole on 15 jun 2018 reason its taking too much time
            ...
            try
            {
                ...
                DataTable dt_newMemberDetails = vw_newMemberDetails.ToTable(true, "profileID", "masterID", "grpID", "memberName", "memberEmail", "memberMobile", "memberCountry", "profilePic", "familyPic", "isAdmin", "isPersonalDetVisible", "isBusinDetVisible", "isFamilDetailVisible");
                ...
                DataTable dt_UpdateMemberDetails = vw_UpdateMemberDetails.ToTable(true, "profileID", "masterID", "grpID", "memberName", "memberEmail", "memberMobile", "memberCountry", "profilePic", "familyPic", "isAdmin", "isPersonalDetVisible", "isBusinDetVisible", "isFamilDetailVisible");
        ...
        public static List<UserLogin> GetMemberDetails(string masterUID)
        {
            try
            {
                ...
                var Result = _DBTouchbase.ExecuteStoreQuery<UserLogin>("CALL USPMembersDetails(?masterUID)", masterID).ToList();
        ...
        public static List<CelebrationList> getBdayAnnList(string memberId, string groupId, string date)
        {
            try
            {
                ...
                var Result = _DBTouchbase.ExecuteStoreQuery<CelebrationList>("CALL USPGetBdayAnnList(?memberId,?grpId,?date)", MemID, GrpId, date1).ToList();
                return Result;
            }
            catch (Exception ex)
            {
        ...
        public static List<MemberListResult> GetDirectoryList(int masterUID, string grpID, string searchText, string updatedOn, int isSubGrpAdmin, string profileID)
        {
            try
            {
                ...
                if (isSubGrpAdmin == 0)
                {
                    ...
                    Result = _DBTouchbase.ExecuteStoreQuery<MemberListResult>("CALL V3_USPGetDirectoryList(?masterUID,?groupID,?SearchText,?updatedOn)", master_ID, groupID, SearchText, UpdatedOn).ToList();
                }
                else
                {
        ...
        public static object UploadFile(string FileName, string ModuleName, string filetype)
        {
            try
            {
                ...
                var Result = _DBTouchbase.ExecuteStoreQuery<int>("CALL USPAdd_Image(?fileName,?moduleName,?filetype)", fileName, moduleName, file).SingleOrDefault();
                return Result;
            }
            catch (Exception ex)
            {
        ...
        public static object EditPhoto(string FileName, string ProfileID, string Type)
        {
            try
            {
                ...
                var Result = _DBTouchbase.ExecuteStoreQuery<int>("CALL USP_UploadFoto(?fileName,?profileID,?type)", param).SingleOrDefault();
                return Result;
            }
            catch (Exception ex)
            {
        ...
        public static string updateMemberDetails(MemberProfileUpdate member)
        {
            try
            {
                ...
                var result = _DBTouchbase.ExecuteStoreQuery<string>("CALL USPUpdateMemberDetails(?memberId,?mem_name,?mem_email,?image_ID)", memberId, mem_name, mem_email, Image_ID).SingleOrDefault();
        ...
        public static int UpdateAddressDetails(AddressResultInput add)
        {
            try
            {
                ...
                var Result = _DBTouchbase.ExecuteStoreQuery<int>("CALL USPUpdateAddressDetails(?addressID,?addressType,?address,?city,?state,?country,?pincode,?phoneNo,?fax,?userID,?groupID)", addressID, addressType, address, city, state, country, pincode, phoneNo, fax, userID, groupID).SingleOrDefault();
                return Result;
            }
            catch
            {
        ...
        public static int UpdateFamilyDetails(UpdateFamilyDetail mem)
        {
            try
            {
                ...
                var Result = _DBTouchbase.ExecuteStoreQuery<int>("CALL USPUpdateFamilyDetails(?familyMemberId,?memberName,?relationship,?dOB,?anniversary,?contactNo,?particulars,?bloodGroup,?emailID,?profileID)",
        ...
        public static int UpdateDeviceToken(string deviceToken, string MemID)
        {
            try
            {
                ...
                var Result = _DBTouchbase.ExecuteStoreQuery<int>("CALL USPUpdateDeviceToken(?dToken,?memID)", DeviceToken, UserID).SingleOrDefault();
                return Result;
            }
            catch
            {
        ...
        public static List<SearchFilters> GetSearchFilters(string grpID)
        {
            try
            {
                ...
                var Result = _DBTouchbase.ExecuteStoreQuery<SearchFilters>("CALL V6_USPGetSearchFilters(?grpID)", groupID).ToList();
                return Result;
            }
            catch
            {
        ...
        public static List<MemberListResult> AdvanceSearch(AdvanceSearchInput input)
        {
            try
            {
                ...
                var Result = _DBTouchbase.ExecuteStoreQuery<MemberListResult>(squery.ToString(), string.Empty).ToList();
                foreach (MemberListResult mem in Result)
                {
                    if (!string.IsNullOrEmpty(mem.pic))
                    {
        ...
        public static List<BODListResult> GetBODList(string grpId, string searchText)
        {
            ...
            try
            {
                result = _DBTouchbase.ExecuteStoreQuery<BODListResult>("CALL V1_USPGetBODList(?groupId,?searchText)", parameters).ToList();
