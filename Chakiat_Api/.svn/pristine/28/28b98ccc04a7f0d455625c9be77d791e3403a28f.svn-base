    ...
    public class Attendance
    {
        ...
        public static List<newMembers> getAttendanceMemberDetails(GetAttendanceDetails_Input Input)
        {
            try
            {
                ...
                var Result = _DbTouchbase.ExecuteStoreQuery<newMembers>("CALL USP_API_Mobile_AttendanceTypeDetails(?p_AttendanceID,?p_Type)", param).ToList();
                return Result;
            }
            catch (Exception ex)
            {
        ...
        public static List<newAnns> getAttendanceAnnsDetails(GetAttendanceDetails_Input Input)
        {
            try
            {
                ...
                var Result = _DbTouchbase.ExecuteStoreQuery<newAnns>("CALL USP_API_Mobile_AttendanceTypeDetails(?p_AttendanceID,?p_Type)", param).ToList();
                return Result;
            }
            catch (Exception ex)
            {
        ...
        public static List<newAnnets> getAttendanceAnnetsDetails(GetAttendanceDetails_Input Input)
        {
            try
            {
                ...
                var Result = _DbTouchbase.ExecuteStoreQuery<newAnnets>("CALL USP_API_Mobile_AttendanceTypeDetails(?p_AttendanceID,?p_Type)", param).ToList();
                return Result;
            }
            catch (Exception ex)
            {
        ...
        public static List<newVisitors> getAttendanceVisitorsDetails(GetAttendanceDetails_Input Input)
        {
            try
            {
                ...
                var Result = _DbTouchbase.ExecuteStoreQuery<newVisitors>("CALL USP_API_Mobile_AttendanceTypeDetails(?p_AttendanceID,?p_Type)", param).ToList();
                return Result;
            }
            catch (Exception ex)
            {
        ...
        public static List<newRotarians> getAttendanceRotariansDetails(GetAttendanceDetails_Input Input)
        {
            try
            {
                ...
                var Result = _DbTouchbase.ExecuteStoreQuery<newRotarians>("CALL USP_API_Mobile_AttendanceTypeDetails(?p_AttendanceID,?p_Type)", param).ToList();
                return Result;
            }
            catch (Exception ex)
            {
        ...
        public static List<GetAttendanceRotarianDetailsbyID> GetrotarianDetailsbyRotarianID(GetAttendanceRotarian_Input Input)
        {
            try
            {
                ...
                var Result = _DbTouchbase.ExecuteStoreQuery<GetAttendanceRotarianDetailsbyID>("CALL USP_API_Mobile_GetrotarianDetailsbyRotarianID(?p_RotarianID)", param).ToList();
                return Result;
            }
            catch (Exception ex)
            {
        ...
        public static List<GetAttendanceDelegateDetailsByRotarianName> GetAttendanceDistrinctDelegateDetailsByRotarianName(GetAttendanceRotarian_Input Input)
        {
            try
            {
                ...
                var Result = _DbTouchbase.ExecuteStoreQuery<GetAttendanceDelegateDetailsByRotarianName>("CALL USP_API_Mobile_GetAttendanceDistrinctByRotarianName(?p_RotarianName)", param).ToList();
                return Result;
            }
            catch (Exception ex)
            {
