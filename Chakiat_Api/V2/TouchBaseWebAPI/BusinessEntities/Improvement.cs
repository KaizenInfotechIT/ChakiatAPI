    ...
    public class Improvement
    {
        ...
        public static List<ImprovementList> GetImprovementDetails(ImprovementDetail imp)
        {
            try
            {
                ...
                var Result = _DBTouchbase.ExecuteStoreQuery<ImprovementList>("CALL V4_USPGetImprovementDetails(?imprID,?grpID,?memberProfileID)", imprID, grpID, memberProfileID).ToList();
        ...
        public static Imgname createImprovement(AddImprovement imp)
        {
            try
            {
                ...
                var Result = _DBTouchbase.ExecuteStoreQuery<Imgname>("CALL V4_USPAddImprovement(?imprID,?imprType,?imprTitle,?imprDesc,?memID,?grpID,?memprofileIDs,?ImprovementImg,?publishDate,?expiryDate,?sendSMSAll,?sendSMSNonSmartPh)",
