...
namespace TouchBaseWebAPI.Models
{
    ...
    public class ClsAssistance
    {
        public string mobileNo { get; set; }
    }

    public class ClsDashboardInput
    {
        public string MasterId { get; set; }
    }

    public class ClsFinalDashboardOutput
    {
        public List<ClsDashboardOutput> Birthday { get; set; }
        public List<ClsDashboardOutput> Anniversary { get; set; }
        public List<ClsDashboardOutput> Event { get; set; }
    }

    public class ClsDashboardOutput
    {
        public string Title { get; set; }
        public string Description { get; set; }
        public string TodaysCount { get; set; }
        public string ClubName { get; set; }
    ...
    public class SharedTransaction_Input
    {
        public string TransactionType { get; set; }
        public string TransactionID { get; set; }
    }
    public class SharedTransaction_OUTPUT
    {
        public string TransactionID { get; set; }
        public string TransactionTitle { get; set; }
        public string TransationDesc { get; set; }
        public string TransactionImg { get; set; }
        public string TransactionVenue { get; set; }
        public string TransactionEventDate { get; set; }
        public string TransactionPublishDate { get; set; }
        public string TransactionExpiryDate { get; set; }
        public string TransactionLink { get; set; }
        public string GroupID { get; set; }
        public string grpname { get; set; }
    }
    public class UpdateDeviceTokenNumberIPut
    {
        public string MobileNumber { get; set; }
        public string DeviceToken { get; set; }
    }

    public class Zonelistoutput
    {
        public string PK_zoneID { get; set; }
        public string zoneName { get; set; }
    }

    public class AdminSubmodulesInput
    {
        public string Fk_groupID { get; set; }
        public string fk_ProfileID { get; set; }
    }

    public class AdminSubmoduleslist
    {
        public string ModuleID { get; set; }
        public string Title { get; set; }
    ...
    public class MobilePopuplist
    {
        public string FkmasterID { get; set; }
        public string PK_Popup_ID { get; set; }
        public string Description { get; set; }
