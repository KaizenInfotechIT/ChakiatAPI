...
namespace TouchBaseWebAPI.Models
{
    ...
    public class EventsDetail
    {
        ...
        public int displayonbanner { get; set; }
    ...
    public class smscountInputs
    {
        public string p_RecipientType { get; set; }
        public string p_InputIDs { get; set; }
        public string P_fk_Group_masterid { get; set; }
        public string p_DescriptionCount { get; set; }
        public string p_Remindercount { get; set; }
        public string p_TransType { get; set; }
        public string p_PublishDateFlag { get; set; }
    }
}