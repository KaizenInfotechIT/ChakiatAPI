...
namespace TouchBaseWebAPI.Models
{
    public static class GlobalFuns
    {
        ...
        public static bool SendSMSOnAdd(string strMobile, string strAlertText)
        {
            ...
            string dn = ConfigurationManager.AppSettings["NewURL"].ToString();
            string usr = ConfigurationManager.AppSettings["NewUser"].ToString();
            string pwd = ConfigurationManager.AppSettings["NewKey"].ToString();
            string sid = ConfigurationManager.AppSettings["NewSenderID"].ToString();
            try
            {
        ...
        public static bool SendSMSAdd(string NewURL, string User, string Password, string SenderID, string PhoneNumber, string TextMessage)
        {
            string strValue = string.Empty;
            ...
            sbPostData.AppendFormat("&key={0}", Password);
            sbPostData.AppendFormat("&mobile={0}", PhoneNumber);
            sbPostData.AppendFormat("&message={0}", message);
            sbPostData.AppendFormat("&senderid={0}", SenderID);
            sbPostData.AppendFormat("&accusage={0}", "1");
            try
            {
                string sendSMSUri = NewURL;
