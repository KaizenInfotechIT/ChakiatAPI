    ...
    public class Gallery
    {
        ...
        public static ClsPhotoListOutput GetAlbumPhotoList(ClsPhotoListInput album)
        {
            try
            {
                ...
                DataSet result = MySqlHelper.ExecuteDataset(GlobalVar.strAppConn, CommandType.StoredProcedure, "V4_1_USPAlbumList", parameterList);
        ...
        public static int AddUpdateAlbumPhoto(string photoId, string imageName, string desc, string albumId, string createdBy)
        {
            ...
            try
            {
                result = MySqlHelper.ExecuteNonQuery(GlobalVar.strAppConn, CommandType.StoredProcedure, "V4_1_USPAddAlbumPhoto", parameterList);
            }
            catch
            {
                throw;
        ...
        public static int DelteAlbumPhoto(ClsDeletePhotoInput photo)
        {
            ...
            try
            {
                result = MySqlHelper.ExecuteNonQuery(GlobalVar.strAppConn, CommandType.StoredProcedure, "V4_1_USPDeleteAlbumPhoto", parameterList);
            }
            catch
            {
                throw;
        ...
        public static List<ClsGetAlbumDetailsOutput> GetAlbumDetails_New(ClsGetAlbumDetailsInput album)
        {
            try
            {
                ...
                {
                    context.Connection.Open();
                    var Result = context.ExecuteStoreQuery<ClsGetAlbumDetailsOutput>("CALL V6_1_USPGetAlbumDetails_New(?AlbumId)", parameterList).ToList();
        ...
        public static List<cls_NotificationDetails> GetNotificationlist(cls_NotificationInput Notification)
        {
            try
            {
                MySqlParameter[] parameterList = new MySqlParameter[2];

                parameterList[0] = new MySqlParameter("?p_GroupID", Notification.GroupID);
                parameterList[1] = new MySqlParameter("?p_Type", Notification.Type);

                using (TouchBaseWebAPI.Data.row_productionEntities context = new TouchBaseWebAPI.Data.row_productionEntities())
                {
                    context.Connection.Open();
                    var Result = context.ExecuteStoreQuery<cls_NotificationDetails>("CALL Web_Activity_Notification_List_Get(?p_GroupID,?p_Type)", parameterList).ToList();
